...
saveRDS(stem, file = "result/randomforest_wedge_bootstrap.RDS") 
...
figure.wedge.randomforest <- data.frame(dataset, model, by, measurement, value); dim(figure.wedge.randomforest)
saveRDS(figure.wedge.randomforest, 'result/figure_wedge_randomforest.RDS')
...
saveRDS(rate.drug, file = "result/randomforest_wedge_bootstrap_drug_rate.RDS") 
...
saveRDS(pred.drug, file = "result/randomforest_wedge_bootstrap_drug_confusion.RDS") 
