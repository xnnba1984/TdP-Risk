...
for(d in drug){
  ...
  #model1 <- glm(risk1~c3v2,family = 'binomial', data = train, control = list(maxit = 50))
  ...
  model2 <- glm(risk2~c3v1+c3v2+c3v3+c3v4+c3v6+c3v7+c3v8+c3v9+c3v10+c3v11+c3v12+c3v13+c3v14+c3v15+c3v16,
               family = 'binomial', data = train, control = list(maxit = 50))
  #model2 <- glm(risk2~c3v2,family = 'binomial', data = train, control = list(maxit = 50))
